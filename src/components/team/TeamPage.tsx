...
const teamMembers: TeamMember[] = [
  {
    ...
    image: `${headshotBase}/Dr. Qaisar H. Metawea.webp`,
    description: [
  ...
  { name: "Yasser Mousa", role: "Counsel - Head of Riyadh", email: "yam@qhmlawfirm.com", image: `${headshotBase}/Yasser Mousa.webp` },
  { name: "Tamer Elnagar", role: "Counsel", email: "hmb@qhmlawfirm.com", image: `${headshotBase}/Tamer Elnagar.webp` },
  { name: "Abdulelah Ashmawi", role: "Senior Associate", email: "ama@qhmlawfirm.com", image: `${headshotBase}/Abdulelah Ashmawi.webp` },
  { name: "Amna Usman", role: "Managing Associate", email: "anu@qhmlawfirm.com", image: `${headshotBase}/Amna Usman.webp` },
  { name: "Hamed Matawi", role: "Managing Associate", email: "ham@qhmlawfirm.com", image: `${headshotBase}/Hamed Matawi.webp` },
  { name: "Moayd Johar", role: "Managing Associate", email: "mhj@qhmlawfirm.com", image: `${headshotBase}/Moayd Johar.webp` },
  { name: "Mahmoud Bashandy", role: "Managing Associate", email: "msb@qhmlawfirm.com", image: `${headshotBase}/Mahmoud Bashandy.webp` },
  { name: "Deema Daqqaq", role: "Associate", email: "dad@qhmlawfirm.com", image: `${headshotBase}/Deema Daqqaq.webp` },
  { name: "Tamara Khattab", role: "Associate", email: "thk@qhmlawfirm.com", image: `${headshotBase}/Tamara Khattab.webp` },
  { name: "Talah Reda", role: "Junior Associate", email: "tkr@qhmlawfirm.com", image: `${headshotBase}/Talah Reda.webp` },
  { name: "Abdulmajeed Ghandoorah", role: "Trainee Lawyer", email: "ahg@qhmlawfirm.com", image: `${headshotBase}/Abdulmajeed Ghandoorah.webp` },
  { name: "Oays Mansouri", role: "Trainee Lawyer", email: "omm@qhmlawfirm.com", image: `${headshotBase}/Oays Mansori.webp` },
  { name: "Nada Al Mehdar", role: "Finance", email: "nat@qhmlawfirm.com", image: `${headshotBase}/Nada Al Mehdar.webp` },
];
